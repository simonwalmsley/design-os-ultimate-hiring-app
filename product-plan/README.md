# Ultimate Hiring Process - Design Handoff

This folder contains everything needed to implement Ultimate Hiring Process.
...
**Design Assets:**
- `design-system/` - Colours, fonts, design tokens
- `data-model/` - Core entities and TypeScript types
- `shell/` - Application shell component
...
- **Use the pre-written prompts** - They include important clarifying questions about auth and data modelling.
- **Add your own notes** - Customise prompts with project-specific context when needed.
